...
WHERE
  --- Not Stock managed
  (ITMMASTER.STOMGTCOD_0 = 1 AND ITMMASTER.TCLCOD_0 NOT IN ('F0001','F0002','F0003','F0004','S0001','S0002','S0003'))  
  OR (ITMMASTER.TCLCOD_0 = 'S0003' AND ITMMASTER.TSICOD_1 = 'MEC01' AND ITMMASTER.SERMGTCOD_0 != 1)
  ...
  OR (ITMMASTER.TCLCOD_0 = 'P0003' AND ITMMASTER.SERMGTCOD_0 != 1)
