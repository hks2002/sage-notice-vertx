 ...
 * @LastEditDate          : 2025-12-16 15:52:42                                                                       *
...
@Log4j2
public class DeadPurchaseLineByFFC extends BaseJob {
  @Override
  protected void executeJob(JobExecutionContext context) throws JobExecutionException {
    jobName = "DEAD_PURCHASE_LINE_BY_FFC";

    DB.queryByFile(this.getClass().getSimpleName(), params)
        .onSuccess(list -> {
          if (list.isEmpty()) {
            log.info("No dead purchase line by FFC found for site: {}", site);
          } else {
            ...
            msg.append("<table>")
                ...
                .append(TH.N(i18n.getString("INVOICE_NO")))
                .append(TH.N(i18n.getString("INVOICE_DATE")))
                .append("</tr>")
                .append("</thead>");
            ...
            for (int i = 0; i < list.size(); i++) {
              ...
              msg.append("<tr>")
                  ...
                  .append(TD.N(obj.getString("InvoiceNO")))
                  .append(TD.N(L.getDate(obj.getLong("InvoiceDate"), locale)))
                  .append("</tr>");
          ...
          log.error("Error dead purchase line  by FFC for site {}: {}", site, err.getMessage());
        });
  }
