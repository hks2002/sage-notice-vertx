 ...
 * @LastEditDate          : 2025-11-07 14:16:05                                                                      *
...
@Log4j2
public class MixWOProjectNO extends BaseJob {
  @Override
  public void executeJob(JobExecutionContext context) throws JobExecutionException {
    jobName = "MIX_WO_PROJECT_BETWEEN_ZHU_YSH";

    DB.queryByFile(this.getClass().getSimpleName(), params)
        .onSuccess(list -> {
          if (list.isEmpty()) {
            log.info("No mix project for WO between ZHU and YSH found for site: {}", site);
          } else {
